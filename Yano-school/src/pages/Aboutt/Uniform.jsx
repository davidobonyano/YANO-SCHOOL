     ...
     <div className="w-16 h-[2px] mt-2 bg-red-400 rounded-full"></div>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="bg-white rounded-2xl shadow-md overflow-hidden">
            ...
            />
            <div className="p-4">
              <h3 className="text-xl font-semibold text-blue-700">Boys Regular</h3>
          ...
          <div className="bg-white rounded-2xl shadow-md overflow-hidden">
            ...
            />
            <div className="p-4">
              <h3 className="text-xl font-semibold text-pink-700">Girls Regular</h3>
              <p className="text-gray-600 text-sm mt-1">
          ...
          <div className="bg-white rounded-2xl shadow-md overflow-hidden">
            ...
            />
            <div className="p-4">
              <h3 className="text-xl font-semibold text-green-700">Sportswear</h3>
              <p className="text-gray-600 text-sm mt-1">
          ...
          <div className="bg-white rounded-2xl shadow-md overflow-hidden">
            ...
            />
            <div className="p-4">
              <h3 className="text-xl font-semibold text-yellow-700">Friday Polo</h3>
              <p className="text-gray-600 text-sm mt-1">
