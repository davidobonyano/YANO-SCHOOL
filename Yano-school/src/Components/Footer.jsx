      ...
      <div className="border-t border-gray-300 py-6">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex space-x-4 text-xl mt-4 md:mt-0 ">
            <a href="#" aria-label="Facebook" className=" flex justify-center items-center border border-black w-10 h-10 rounded-full hover:text-blue-600 transition">
              <FontAwesomeIcon icon={faFacebookF} />
            </a>
            <a href="#" aria-label="Twitter" className=" flex justify-center items-center border border-black w-10 h-10 rounded-full hover:text-sky-500 transition">
              <FontAwesomeIcon icon={faTwitter} />
            </a>
            <a href="#" aria-label="Instagram" className=" flex justify-center items-center border border-black w-10 h-10 rounded-full hover:text-pink-500 transition">
              <FontAwesomeIcon icon={faInstagram} />
            </a>
            <a href="#" aria-label="YouTube" className=" flex justify-center items-center border border-black w-10 h-10 rounded-full hover:text-red-600 transition">
